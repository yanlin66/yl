<template>
  <div>
    <div class="warp-two">
      ...
      <!--提示信息-->
      <maskError  ref="child" @click="closeTip"></maskError>
      <!--活动规则-->
...
<script>
  ...
  export default {
    ...
    methods:{
      gotwo(){
        this.$router.push({ path:'/firsttwo'})
      },
      showrule(){
        $(".mask_rule").fadeIn();
      },
        ...
        if(!$("#phone").val()){
          ...
          switch (that.prizestatus){
            ...
            case 0:
              ...
              break;
            case 1:
              this.$router.push({ path:'/oneprize'});
              break;
            case 2:
              this.$router.push({ path:'/twoprize'});
              break;
            case 3:
              this.$router.push({ path:'/threeprize'});
              break;
            default:
              return false;
          }
